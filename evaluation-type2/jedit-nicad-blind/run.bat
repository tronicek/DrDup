...
java -cp %TOOL_JAR% nicad.Diff %NICAD8d% drdup-jedit-3-separated.xml nicad-blind-8-drdup-3.xml
java -cp %TOOL_JAR% nicad.Diff drdup-jedit-8-separated.xml %NICAD3d% drdup-8-nicad-blind-3.xml
