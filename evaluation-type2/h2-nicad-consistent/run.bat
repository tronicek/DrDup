...
java -cp %TOOL_JAR% nicad.Diff %NICAD10d% drdup-h2-5-separated.xml nicad-consistent-10-drdup-5.xml
java -cp %TOOL_JAR% nicad.Diff drdup-h2-10-separated.xml %NICAD5d% drdup-10-nicad-consistent-5.xml
