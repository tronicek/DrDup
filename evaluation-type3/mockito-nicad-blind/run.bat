set NICAD6="mockito-blind-0.50-minsize-6.xml"
set NICAD6d="mockito-blind-0.50-minsize-6-dir.xml"
set NICAD16="mockito-blind-0.05-minsize-16.xml"
set NICAD16d="mockito-blind-0.05-minsize-16-dir.xml"
...
java %OPTIONS% -cp %TOOL_JAR% nicad.Diff %NICAD16d% drdup-mockito-8.xml nicad-blind-16-drdup-8.xml
java %OPTIONS% -cp %TOOL_JAR% nicad.Diff drdup-mockito-16.xml %NICAD6d% drdup-16-nicad-blind-6.xml
