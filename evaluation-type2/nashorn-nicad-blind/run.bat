...
java -cp %TOOL_JAR% nicad.Diff %NICAD10d% drdup-nashorn-5-separated.xml nicad-blind-10-drdup-5.xml
java -cp %TOOL_JAR% nicad.Diff drdup-nashorn-10-separated.xml %NICAD5d% drdup-10-nicad-blind-5.xml
