set NICAD6="jedit-consistent-0.50-minsize-6.xml"
set NICAD6d="jedit-consistent-0.50-minsize-6-dir.xml"
set NICAD16="jedit-consistent-0.05-minsize-16.xml"
set NICAD16d="jedit-consistent-0.05-minsize-16-dir.xml"
...
java %OPTIONS% -cp %TOOL_JAR% nicad.Diff %NICAD16d% drdup-jedit-8.xml nicad-consistent-16-drdup-8.xml
java %OPTIONS% -cp %TOOL_JAR% nicad.Diff drdup-jedit-16.xml %NICAD6d% drdup-16-nicad-consistent-6.xml
