set NICAD5="nashorn-blind-0.50-minsize-5.xml"
set NICAD5d="nashorn-blind-0.50-minsize-5-dir.xml"
set NICAD12="nashorn-blind-0.03-minsize-12.xml"
set NICAD12d="nashorn-blind-0.03-minsize-12-dir.xml"
...
java %OPTIONS% -cp %TOOL_JAR% nicad.Diff %NICAD12d% drdup-nashorn-6.xml nicad-blind-12-drdup-6.xml
java %OPTIONS% -cp %TOOL_JAR% nicad.Diff drdup-nashorn-12.xml %NICAD5d% drdup-12-nicad-blind-5.xml
