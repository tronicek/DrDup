...
java -cp %TOOL_JAR% nicad.Diff %NICAD8d% drdup-mockito-3-separated.xml nicad-blind-8-drdup-3.xml
java -cp %TOOL_JAR% nicad.Diff drdup-mockito-8-separated.xml %NICAD3d% drdup-8-nicad-blind-3.xml

java -cp %TOOL_JAR% nicad.Sourcer %SRC_DIR% nicad-blind-8-drdup-3.xml
java -cp %TOOL_JAR% nicad.Sourcer %SRC_DIR% drdup-8-nicad-blind-3.xml
